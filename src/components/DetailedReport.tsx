...
export default function DetailedReport({ report, onBack }: DetailedReportProps) {
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      const response = await fetch('https://nik0018.app.n8n.cloud/webhook/eb01def9-52cd-4ad3-bda6-aa2099f09e50', {
        method: 'POST',
        headers: {
  ...
  const handleEmail = async () => {
    ...
    try {
      const url = new URL('https://nik0018.app.n8n.cloud/webhook/4a1dceb0-9a91-432c-b245-76eabe6216e9');
